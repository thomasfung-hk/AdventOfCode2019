...
def runComputerWithoutInputs(puzzle_input):
    computer = IntcodeComputer(puzzle_input)
    return computer.runCode()
...
def partOne(puzzle_input):
    computer = IntcodeComputer(puzzle_input, 1)
    keycode = computer.runCode()
    print(f"The BOOST keycode is {keycode}.")
    return

def partTwo(puzzle_input):
    computer = IntcodeComputer(puzzle_input, 2)
    keycode = computer.runCode()
    print(f"The coordinates is {keycode}.")
    return
